...
using ErisLib.Game.Utils;
using ErisLib.Server.Packets;
using ErisLib.Server.Packets.Models;

namespace ErisLib.Game.Packets
{
    public struct PacketStructure : IStructure<byte>
    {
        ...
        public PacketStructure(XElement packet) {
            ...
            foreach (Type pType in packetTypes) {
                PacketType t = ((Packet) Activator.CreateInstance(pType)).Type;
                if (t == PacketType) {
                    Type = pType;
                }
            }
